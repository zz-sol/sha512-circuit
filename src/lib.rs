...
pub use proof_api::{
    ...
    Sha512Seed32PrivateProof, Sha512SingleBlockInstance, Sha512SingleBlockProof, Sha512StarkConfig,
    Sha512StarkProof, deserialize_message_instance, deserialize_multi_block_proof,
    deserialize_seed32_private_proof, deserialize_single_block_instance,
    deserialize_single_block_proof, prove_message, prove_message_with_settings,
    prove_seed32_private, prove_seed32_private_with_settings, prove_single_block,
    ...
    verify_seed32_private_proof_with_settings, verify_single_block_proof,
