...
pub(super) const PREP_ROUND_SELECTOR_COL: usize = WORD_T1;
pub(super) const PREP_INIT_W_SELECTOR_COL: usize = WORD_T2;
pub(super) const PREP_SCHEDULE_SELECTOR_COL: usize = WORD_SIGMA0;
pub(super) const PREP_FINAL_SELECTOR_COL: usize = WORD_SIGMA1;
